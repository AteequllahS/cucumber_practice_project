...
public class WOrderPage {
    ...
    //Order tab page product drop down list
    public List<String> getAllProductDropDownOptions(){

        Select select = new Select(productDropdown);

        //to store each option as WebElement
        List<WebElement> allOptions = select.getOptions();
        //to store the text of each option
